...
class Bkk extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('M_bkk');
        $this->load->model('M_bank');
    }

    public function index()
    {
        $data['bkk'] = $this->M_bkk->viewBkk();
    ...
    {
        $kodeunik1 = $this->M_bkk->buat_kode_bank();
        $data['kodebank'] = $this->M_bkk->buat_kode_bank();
        $data['kodekas'] = $this->M_bkk->buat_kode_kas();
    ...
    public function ubah($no_dok)
    {
        ...
        $data['bkk'] = $this->M_bkk->getById($no_dok);
