                         	...
                         	<div class="form-inline">
								...
								<div class="form-inline">
									<div class="input-group sm-4">
										<input class="form-control" type="text" name="kd_jenis" value="<?= $dtl['kd_jenis'] ?>" id="kd_jenis" style="width:225px;" hidden>
										<input class="form-control" type="text" name="kd_detail" value="<?= $dtl['kd_detail'] ?>" id="kd_detail" style="width:225px;" hidden>
							...
							<div class="form-inline">
								<label class="" for="kode">Pekerjaan/Part</label>&nbsp &nbsp
									...
									<?php
										...
										?>
										<input class="form-control" type="text" name="jenis_pekerjaan" value="<?= $j['nama'] ?>" id="jenis_pekerjaan" style="width:230px;" autocomplete="off" readonly>
										<?php } ?>
										<?php endforeach ?>
									</div>
