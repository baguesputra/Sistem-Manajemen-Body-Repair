	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card border-secondary" >
				...
				<div class="card-body">
				<a href="<?= base_url('pembelian/postpart/'); ?><?= $pembelian['kd_pemb'] ?>" class="btn btn-success" style="margin-left:1225px;position:absolute;">Post</a>
					<div class="row">
							...
							<div class="form-inline">
								...
								<label class="col-sm-2" for="id">Bayar</label>
									<div class="col-sm-2">
										...
										<?php endforeach ?>
										<input class="form-control" type="text" name="bayar2" id="bayar2" value="<?= $pembelian['total'] ?>" onkeyup="sum();" style="width:188px;" hidden>
										<input class="form-control" type="text" name="bayar3" id="bayar3" value="" style="width:188px;" onkeyup="sum();" hidden>
									</div>
							</div>
						<br>
						...
						<hr>
                         	...
                         	<div class="form-inline">
								...
								<div class="col-sm-3">
									...
									<a href="javascript:void(0);" NAME="My Window Name" title=" My title here "
										onClick='javascript:window.open("<?= base_url('pembelian/poppart'); ?>","Ratting",
                      	...
                      	<br>
							<div class="form-inline">
								...
								<label class="col-sm" for="id">Diskon Rp</label>
									<div class="col-xs-1">
										<input class="form-control" type="text" name="diskonRp" value="0" id="diskonRp" style="width:120px;" onkeyup="sum();"  autocomplete="off">
									</div>
...
<script>
      	function sum() {
			...
			var total = parseInt(result) - parseInt(disk) - parseInt(diskonRp);
