...
<div class="container-fluid">
		...
		<h3><i class="fa fa-bookmark"></i>	Detail Nota Debit AP</h3>
	<div class="row">
		<div class="col-lg-12">
			...
			<br>
				<div class="class table-responsive">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<a href="<?= base_url('nota_ap/indexDebit'); ?>" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i> Kembali</a>
						</div>
					</div>
				<br>
			</div>
