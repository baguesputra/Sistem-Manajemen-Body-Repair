...
<div class="container-fluid">
		...
		<h3><i class="fa fa-bookmark"></i>	Detail Bank Keluar</h3>
	<div class="row">
		<div class="col-lg-12">
			<div class="card border-secondary" >
				...
				<div class="row">
							<div class="form-inline">
									...
									<div class="col-xs-3">
										<input class="form-control" type="text" name="no_dok" id="no_dok" value="<?= $bbk['no_dok'] ?>" style="width:188px;" readonly>
										
										
									</div>
									<label class="col-sm-2" for="id">Tanggal</label>
									<div class="col-sm-2">
										<input class="form-control" type="date" name="tgl" id="tgl" value="<?= $bbk['tgl'] ?>" style="width:188px;" readonly>
									</div>
							</div>
						...
						<div class="row">
							...
							<div class="form-inline">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="kd_bank" id="kd_bank" value="<?= $bbk['kd_bank'] ?>"  style="width:230px;" readonly>
								</div>
							...
							<div class="col">
								<div class="form-inline">
									...
									<select class="form-control" name="tipe" id="tipe" style="width:435px;" readonly>
										<option value="" selected ><?= $bbk['tipe'] ?></option>
									</select>
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="bayar" id="bayar" value="<?= $bbk['bayar'] ?>" onkeyup="sum();" style="width:430px;" readonly>
								</div>
								</div>
										</div>
										</div>
						...
						<div class="input-group sm-3">
							<input class="form-control"  type="text" name="pemasok" id="pemasok" value="<?= $bbk['pemasok'] ?>" style="width:435px;" readonly>
							<input class="form-control"  type="text" name="kode_pemasok" id="kode_pemasok" value="<?= $bbk['kode_pemasok'] ?>" style="width:455px;" readonly hidden>
						...
						<div class="col">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="jumlah" id="jumlah" value="<?= $bbk['jumlah'] ?>"  style="width:430px;" readonly>
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="selisih" id="selisih" value="<?= $bbk['selisih'] ?>" onkeyup="sum();"  style="width:430px;" readonly>
								...
								<div class="col-sm-6">
									<input class="form-control" type="text" name="ket" id="ket" value="<?= $bbk['ket'] ?>"  style="width:430px;" readonly>
								</div>
								</div>
								<br>
</div>
                         	...
                         	<div class="form-inline">
								...
								<div class="col-sm-3">
									...
									<a href="javascript:void(0);" NAME="My Window Name" title=" My title here "
										onClick='javascript:window.open("<?= base_url('bbkk/popinvoice'); ?>","Ratting",
									...
									<a href="javascript:void(0);" NAME="My Window Name" title=" My title here "
										onClick='javascript:window.open("<?= base_url('bbkk/popkwitansi'); ?>","Ratting",
										"width=2000,height=500,left=270,top=70,toolbar=1,status=1,");'>
                      	...
                      	<br>
							<div class="form-inline">
								...
								<label class="col-sm" for="id">tempo</label>
									<div class="col-xs-1">
										<input class="form-control" type="date" name="tgl_tempo" value="" id="tgl_tempo" style="width:140px;" autocomplete="off">
									</div>
								<label class="col-sm" for="id">Total</label>
									<div class="col-xs-1">
										<input class="form-control" type="text" name="total" value="" id="total" style="width:110px;" readonly>
									</div>
			...
			<br>
				<div class="class table-responsive">
					<table class="table table-bordered" style="text-align:center;">
						...
						<tbody>
							<tr>
								<?php 
								$jumlah = 0;
								foreach ($detailbbkk as $dtl): 
									if ($dtl['kode_bbkk'] == $bbk['no_dok']){ ?>
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<a href="<?= base_url('bbkk/indexBbk'); ?>" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i> Kembali</a>
						</div>
					</div>
				<br>
			</div>
