...
<div class="container-fluid">
		...
		<h3><i class="fa fa-bookmark"></i>	Detail Kas Keluar</h3>
	<div class="row">
		<div class="col-lg-12">
			<div class="card border-secondary" >
				...
				<div class="row">
							<div class="form-inline">
									...
									<div class="col-sm-2">
										<input class="form-control" type="date" name="tgl" id="tgl" value="<?= $bkk['tgl'] ?>" style="width:188px;" readonly>
									</div>
							</div>
						...
						<div class="row">
							...
							<div class="form-inline">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="kd_bank" id="kd_bank" value="<?= $bkk['kd_bank'] ?>"  style="width:230px;" readonly>
								</div>
							...
							<div class="col">
								<div class="form-inline">
									...
									<select class="form-control" name="tipe" id="tipe" style="width:435px;" readonly>
										<option value="" selected ><?= $bkk['tipe'] ?></option>
									</select>
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="penerimaan" id="penerimaan" value="<?= $bkk['bayar'] ?>" onkeyup="sum();" style="width:430px;" readonly>
								</div>
								</div>
										</div>
										</div>
						...
						<div class="col">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="jumlah" id="jumlah" value="<?= $bkk['jumlah'] ?>"  style="width:430px;" readonly>
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="selisih" id="selisih" value="<?= $bkk['selisih'] ?>" onkeyup="sum();"  style="width:430px;" readonly>
								...
								<div class="col-sm-6">
									<input class="form-control" type="text" name="ket" id="ket" value="<?= $bkk['ket'] ?>"  style="width:430px;" readonly>
								</div>
								</div>
								<br>
</div>
