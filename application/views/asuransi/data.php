...
<body>
   ...
   <div class="container">
     <div class="panel panel-default">
        ...
        <h5><i class='fa fa-cube fa-fw'></i> Data Master <i class='fa fa-angle-right fa-fw'></i> Asuransi</h5>
                <a href="<?= base_url('asuransi/tambah/'); ?>" class="btn btn-dark mb-3">Tambah Data</a>
               <div class="table-responsive">
                   <table id="example" class="table table-striped table-bordered"  style="text-align:center;">
                       ...
                       <tbody>
                           <?php foreach ($asuransi as $m) : ?>
                               <tr>
                                   <td><?= $m['kd_asuransi']; ?></td>
                                   <td><?= $m['nama_asuransi']; ?></td>
                                   <td><a href="<?= base_url('asuransi/ubah/'); ?><?= $m['kd_asuransi']; ?>" class="badge badge-primary"><i class="fa fa-edit"></i>  Edit</a></td>
