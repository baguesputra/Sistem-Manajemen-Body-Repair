        ...
        <div class="col-md-5">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <input type="hidden" value="<?= $asuransi['kd_asuransi']; ?>" name="kd_asuransi" autocomplete="off">
                    <div class="form-group">
                        <label for="nama">Nama</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?= $asuransi['nama_asuransi']; ?>" autocomplete="off">
