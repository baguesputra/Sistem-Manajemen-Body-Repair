...
<div class="container-fluid">
	<form class="" action="" method="post">
		<h3><i class="fa fa-bookmark"></i>  INPUT BANK TERIMA</h3>
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="card-body">
						<div class="row">
							<div class="form-inline">
									...
									<div class="col-xs-3">
										<input class="form-control" type="text" name="no_dok" id="no_dok" value="<?= $kodebbt ?>" style="width:188px;" readonly>
...
<div class="row">
						...
						<div class="input-group sm-3">
							<input class="form-control"  type="text" name="customer" id="customer" style="width:435px;" readonly>
...
<br>
							...
							<div class="row">
								...
								<div class="col-sm-2" style="text-align: right;">
									<a href="/body-repair/bbkt/indexBbt" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i>Kembali</a>
								</div>
							</div>
							<br>
