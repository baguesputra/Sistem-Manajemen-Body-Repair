...
<div class="container-fluid">
	<form class="" action="" method="post">
		<h3><i class="fa fa-bookmark"></i>  INPUT Nota Kredit</h3>
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="card-body">
						...
						<div class="input-group sm-3">
							...
							<div class="row">
								...
								<div class="col-sm-2" style="text-align: right;">
									<a href="/body-repair/nota_ar/indexKredit" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i>Kembali</a>
								</div>
							</div>
							<br>
