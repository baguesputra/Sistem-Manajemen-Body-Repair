...
<div class="container-fluid">
		...
		<h3><i class="fa fa-bookmark"></i>	Detail Kas Terima</h3>
	<div class="row">
		<div class="col-lg-12">
			<div class="card border-secondary" >
				...
				<div class="row">
							<div class="form-inline">
									...
									<div class="col-xs-3">
										<input class="form-control" type="text" name="no_dok" id="no_dok" value="<?= $bkt['no_dok'] ?>" style="width:180px;" readonly>
										
										
									</div>
									<label class="col-sm-2" for="id">Tanggal</label>
									<div class="col-sm-2">
										<input class="form-control" type="date" name="tgl" id="tgl" value="<?= $bkt['tgl'] ?>" style="width:180px;" readonly>
									</div>
							</div>
						...
						<div class="row">
							...
							<div class="form-inline">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="kd_bank" id="kd_bank" value="<?= $bkt['kd_bank'] ?>"  style="width:230px;" readonly>
								</div>
							...
							<div class="col">
								<div class="form-inline">
									...
									<select class="form-control" name="tipe" id="tipe" style="width:435px;" readonly>
										<option value="" selected ><?= $bkt['tipe'] ?></option>
									</select>
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="penerimaan" id="penerimaan" value="<?= $bkt['penerimaan'] ?>" onkeyup="sum();" style="width:430px;" readonly>
								</div>
								</div>
										</div>
										</div>
						...
						<div class="input-group sm-3">
							<input class="form-control"  type="text" name="customer" id="customer" style="width:455px;" value="<?= $bkt['customer'] ?>" readonly>
						...
						<div class="col">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="jumlah" id="jumlah" value="<?= $bkt['jumlah'] ?>"  style="width:430px;" readonly>
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="selisih" id="selisih" value="<?= $bkt['selisih'] ?>" onkeyup="sum();"  style="width:430px;" readonly>
								...
								<div class="col-sm-6">
									<input class="form-control" type="text" name="ket" id="ket" value="<?= $bkt['ket'] ?>"  style="width:430px;" readonly>
								</div>
								</div>
								<br>
</div>
			...
			<br>
				<div class="class table-responsive">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<a href="<?= base_url('bbkt/indexBkt'); ?>" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i> Kembali</a>
						</div>
					</div>
				<br>
			</div>
