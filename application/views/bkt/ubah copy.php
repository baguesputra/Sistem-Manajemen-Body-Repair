...
<div class="container-fluid">
	<form class="" action="" method="post">
		<h3><i class="fa fa-bookmark"></i>  UBAH KAS TERIMA</h3>
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="card-body">
						<div class="row">
							<div class="form-inline">
									...
									<div class="col-xs-3">
										<input class="form-control" type="text" name="no_dok" id="no_dok" value="<?= $bkt['no_dok'] ?>" style="width:188px;" readonly>
									...
									<div class="col-sm-2">
										<input class="form-control" type="date" name="tgl" id="tgl" value="<?= $bkt['tgl'] ?>" style="width:188px;">
									</div>
							</div>
						...
						<div class="row">
							...
							<div class="form-inline">
								<?php foreach($bank as $b): {?>
									<?php if ($b['kd_bank'] == $bkt['kd_bank']){?>
									<label class="col-sm-2" for="id" style="text-align: right;">Bank Tujuan  </label>
								<div class="input-group sm-3">
									<input class="form-control" type="	text" name="kd_bank" id="kd_bank" value="<?= $b['kd_bank'] ?>"  style="width:190px;" readonly>
								<div class="input-group-append">
									<a href="javascript:void(0);" NAME="My Window Name" title=" My title here "
										onClick='javascript:window.open("<?= base_url('bbkt/popbank'); ?>","Ratting",
							...
							<div class="col">
								<div class="form-inline">
									...
									<select class="form-control" name="tipe" id="tipe" style="width:435px;">
										<option value="<?= $bkt['tipe'] ?>" selected hidden><?= $bkt['tipe'] ?></option>
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="penerimaan" id="penerimaan" value="<?= $bkt['penerimaan'] ?>" onkeyup="sum();" style="width:430px;">
								</div>
								</div>
							</div>
</div>
						...
						<div class="input-group sm-3">
							...
							<input class="form-control"  type="text" name="customer" id="customer" value="<?= $bkt['customer'] ?>" style="width:435px;" readonly>
							<input class="form-control"  type="text" name="kode_cust" id="kode_cust" value="<?= $bkt['kode_cust'] ?>" style="width:455px;" readonly hidden>
							<a href="javascript:void(0);" NAME="My Window Name" title="My title here"
								onClick='javascript:window.open("<?= base_url('spk/popcustomerdata3'); ?>","Ratting",
							...
							<div class="col">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="selisih" id="selisih" value="<?= $bkt['selisih'] ?>"  style="width:430px;" readonly>
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="jumlah" id="jumlah" value="<?= $bkt['jumlah'] ?>" onkeyup="sum();"  style="width:430px;" readonly>
								...
								<div class="col-sm-6">
									<input class="form-control" type="text" name="ket" id="ket" value="<?= $bkt['ket'] ?>"  style="width:430px;">
								</div>
								</div>
								<br>
							...
							<div class="row">
								...
								<div class="col-sm-2" style="text-align: right;">
									<a href="/body-repair/bbkt/indexBkt" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i>Kembali</a>
								</div>
							</div>
							<br>
...
<script>
	function sum() {
		var txtFirstNumberValue = document.getElementById('penerimaan').value;
