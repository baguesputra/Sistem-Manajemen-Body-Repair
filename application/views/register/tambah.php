                ...
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-inline">
                            <label class="col-sm-2" for="kode" hidden>ID Kendaraan</label>
                            <input type="hidden" class="form-control" id="kd_kendaraan" name="kd_kendaraan" value="<?= $kodeunik; ?>" readonly>
                        </div>
                        <br>
                        ...
                        <div class="form-inline">
                            ...
                            <input type="text" class="form-control" id="kd_rangka" name="kd_rangka">
                        ...
                        <div class="form-inline">
                            ...
                            <input type="text" class="form-control" id="kd_mesin" name="kd_mesin">
                        ...
                        <div class="form-inline">
                            ...
                            <input type="text" class="form-control" id="kd_customer" name="kd_customer" readonly style="width:187px; ">
