        ...
        <div class="card-body">
          ...
          <div class="form-inline">
            <label class="col-sm-2" for="kode">No Kwitansi</label>
              <div class="col-sm-3">
                ...
                <label class="col-sm-2" for="id">Tanggal</label>
                  <div class="col-sm-3">
                    <input class="form-control" type="date" name="tgl" value="<?= $kwitansi['tgl']; ?>" id="tgl" autocomplete="off" readonly>
                  </div>
            </div>
            <br>
            ...
            <label class="col-sm-2" for="kode">Sudah Terima Dari</label>
              <div class="col-sm-3">
                <input class="form-control" type="text" name="dari" value="<?= $kwitansi['dari']; ?>" id="dari" autocomplete="off" readonly>
              </div>
            <label class="col-sm-2" for="id">No Ref</label>
              <div class="col-sm-3">
                <input class="form-control" type="text" name="ref" value="<?= $kwitansi['ref']; ?>" id="ref" autocomplete="off" readonly>
              </div>
          </div>
          <br>
          ...
          <label class="col-sm-2" for="kode">Jumlah</label>
              <div class="col-sm-3">
                <input class="form-control" type="text" name="jumlah" value="<?= $kwitansi['jumlah']; ?>" id="jumlah" autocomplete="off" readonly>
              </div>
            <label class="col-sm-2" for="id">Tempo</label>
              <div class="col-sm-3">
                <input class="form-control" type="text" name="tempo" value="<?= $kwitansi['tempo']; ?>" id="tempo" autocomplete="off" readonly>
              </div>
          </div>
          <br>
          ...
          <div class="form-inline">
              ...
              <div class="col-sm-3">
                <!-- <input class="form-control" type="text" name="untuk" value="<?= $kwitansi['untuk']; ?>" id="untuk" autocomplete="off" readonly style="width:730px;"> -->
                <textarea class="form-control" name="untuk" id="untuk" cols="30" rows="5" style="width:730px;" readonly><?= $kwitansi['untuk']; ?></textarea>
              </div>
          </div>
          <br>
