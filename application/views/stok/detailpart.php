				...
				<div class="card-body">
					<div class="row">
							<div class="form-inline">
									...
									<div class="col-xs-3">
										<input class="form-control" type="text" name="no_est" id="no_est" value="<?= $part['kd_part']; ?>"  style="width:188px;"  readonly>
									</div>
									<label class="col-sm-2" for="id">Nama</label>
									<div class="col-sm-2">
										<input class="form-control" type="text" name="tgl_spk" id="tgl_spk" value="<?= $part['nama']; ?>"  style="width:188px;" readonly>
									</div>
							</div>
					</div>
				</form>
			<br>
				<div class="class table-responsive">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<a href="/body-repair/stok/part" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i> Kembali</a>
						</div>
					</div>
				<br>
			</div>
