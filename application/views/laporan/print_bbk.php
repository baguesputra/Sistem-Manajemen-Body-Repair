...
<h5 align="center">BUKTI BANK KELUAR</h5>
<table>
    <tr>
        
            <td style="font-size:0.9rem">No Dokumen</td>
            <td style="font-size:0.9rem">: <?= $bbk['no_dok'] ?></td>
       
    </tr>
    <tr>
        
            <td style="font-size:0.9rem">Tanggal</td>
            <td style="font-size:0.9rem">: <?= date('d M Y', strtotime($bbk['tgl'])); ?></td>
       
    </tr>
    <tr>
        
        <td style="font-size:0.9rem">Pemasok</td>
        <td style="font-size:0.9rem">: <?= $bbk['pemasok'] ?></td>
...
<table style="position:absolute;margin-left:400px;margin-top:-70px;">
                <tr>
                    ...
                    <td style="font-size:0.9rem;">: <?= $bbk['gl_account'] ?></td>
                </tr>
                <tr>
                    <td style="font-size:0.9rem;">Deskripsi</td>
                    <?php foreach($account as $acc){
                        if($acc['no_account'] == $bbk['gl_account']){ ?>
...
<hr>
                <table width="100%">
                    <tr>
                        ...
                        <?php 
                        $no = 1;
                        foreach ($detailbbkk as $detail) : 
                            if ($detail['kode_bbkk'] == $bbk['no_dok']){    
                        ?>
...
<table>
    <tr>
        ...
        <td style="font-size:0.9rem">: Rp.<?= number_format($bbk['bayar'], 0, ',', '.') ?></td>
   
    </tr>
    <tr>
        
        <td style="font-size:0.9rem">Terbilang</td>
        <td style="font-size:0.9rem">: <?= strtoupper(terbilang($bbk['bayar'])) ?> RUPIAH</td>
...
<table align="right">
        ...
        <tr align="center">
            ...
            <td style="font-size:0.9rem; padding-bottom:70px" >Disetujui/Diketahui :</td>                             
        </tr>
        <tr align="center">
            <td style="font-size:0.9rem; ; text-transform: uppercase;" ></td>                             
        </tr>
        <tr align="center">
            <td style="font-size:0.9rem; border-top:1px solid" >Manajer FA</td>
            <td style="font-size:0.9rem; border-top:1px solid" >Director Finance</td>
            <td style="font-size:0.9rem; border-top:1px solid" >Penerima</td>
    ...
    <table align="left">
        ...
        <tr align="center">
            <td style="font-size:0.9rem; border-top:1px solid" >Satff Administrasi</td>
            <td style="font-size:0.9rem; border-top:1px solid" >Coordinator Finance</td>
            <td style="font-size:0.9rem; border-top:1px solid" >Asmen FA</td>
        </tr>
    </table>
</body>
<footer>
