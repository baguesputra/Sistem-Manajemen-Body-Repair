...
<div class="container-fluid">
	<form class="" action="" method="post">
		<h3><i class="fa fa-bookmark"></i>  INPUT Nota Debit Kredit</h3>
		<div class="row">
			<div class="col-lg-12">
					...
					<div class="card-body">
						<div class="row">
							<div class="form-inline">
									...
									<div class="col-sm">
										<input class="form-control" type="text" name="no_dok" id="no_dok" value="<?= $kodekas ?>" style="width:188px;" readonly>
									...
									<label class="col-sm" for="id">Tanggal Terima</label>
									<div class="col-xs-2">
										<input class="form-control" type="date" name="tgl_gl" id="tgl_gl" value="<?php echo date('Y-m-d') ?>" style="width:188px;">
									</div>
							</div>
						...
						<div class="input-group sm-3">
							<input class="form-control"  type="text" name="customer" id="customer" style="width:440px;" readonly>
							...
							<div class="form-inline">
								...
								<div class="col-sm-2">
									<input class="form-control" type="text" name="penerimaan" id="penerimaan" value="" onkeyup="sum();" style="width:430px;">
								</div>
								</div>
								<br>
								<div class="form-inline">
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="jumlah" id="jumlah" value="0"  style="width:430px;" readonly>
								...
								<div class="input-group sm-3">
									<input class="form-control" type="text" name="selisih" id="selisih" value="0" onkeyup="sum();"  style="width:430px;" readonly>
							...
							<div class="row">
								...
								<div class="col-sm-2" style="text-align: right;">
									<a href="/body-repair/nota_ar/indexDebit" class="btn btn-danger float-right btn-block"><i class="fa fa-undo"></i>Kembali</a>
								</div>
							</div>
							<br>
...
<script>
	function sum() {
		var txtFirstNumberValue = document.getElementById('penerimaan').value;
			...
			document.getElementById('selisih').value = txtFirstNumberValue;
	}
	function myFunction() {
