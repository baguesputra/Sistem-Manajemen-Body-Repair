        ...
        <div class="col-md-5">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <input type="hidden" value="<?= $bank['kd_bank']; ?>" name="kd_bank" autocomplete="off">
                    <div class="form-group">
                        <label for="nama">Nama Bank</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?= $bank['nama']; ?>" autocomplete="off">
                        <?= form_error('nama', '<small class="pl-3 text-danger">', '</small>'); ?>
                    </div>

                    <div class="form-group">
                        <label for="nama">Rekening Bank</label>
                        <input type="text" class="form-control" id="account" name="account" value="<?= $bank['account']; ?>" autocomplete="off">
                        <?= form_error('nama', '<small class="pl-3 text-danger">', '</small>'); ?>
                    </div>

                    <div class="form-group">
                        <label for="nama">No Account</label>
                        <input type="text" class="form-control" id="no_account" name="no_account" value="<?= $bank['no_account']; ?>" autocomplete="off">
                        <?= form_error('nama', '<small class="pl-3 text-danger">', '</small>'); ?>
                    </div>

                        <!-- <input type="text" class="form-control" id="created_at" name="created_at" value="<?= $bank['created_at'];?>" autocomplete="off">
                        <?= form_error('nama', '<small class="pl-3 text-danger">', '</small>'); ?>
                        
                        <input type="text" class="form-control" id="created_by" name="created_by" value="<?= $bank['created_by'];?>" autocomplete="off" >
                        <?= form_error('nama', '<small class="pl-3 text-danger">', '</small>'); ?> -->
