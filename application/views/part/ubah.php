            ...
            <div class="card border-secondary">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <input type="hidden" value="<?= $part['kd_part']; ?>" name="kd_part">
                        <div class="form-group">
                            <label for="nama">Nama Sparepart</label>
                            <input type="text" class="form-control" id="nama" name="nama" value="<?= $part['nama']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="stok" name="stok" value="<?= $part['stok']; ?>">
                        </div>
