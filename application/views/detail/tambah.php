          ...
          Tambah Data Detail Pekerjaan
                ...
                <div class="card-body">
                    <form action="" method="post">
                      ...
                      <div class="form-inline">
                        ...
                        <div class="col-sm-2">
                          ...
                          <input class="form-control" type="text" name="no_spk" value="<?= $kodeunik1; ?>" id="no_spk" readonly>
                        ...
                        <div class="col-sm-3">
                          ...
                          "width=550,height=600,left=450,top=200,toolbar=1,status=1,");'>
                  ...
                  <label class="col-sm" for="tipe">Tipe</label>
                      ...
                      <label class="" for="id">Total</label>
                      <div class="col-sm">
                        <input class="form-control" type="text" name="total" value="" id="total" style="width:200px;" readonly>
                      </div>
